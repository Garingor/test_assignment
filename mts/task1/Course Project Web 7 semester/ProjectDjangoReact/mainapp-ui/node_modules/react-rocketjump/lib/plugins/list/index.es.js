...
import { g as getOrSelect, r as rj, S as SUCCESS } from '../../rj-8a6e6805.js';
import 'rxjs';
...
var pickParamsFromUrl = function pickParamsFromUrl(url, pick) {
  if (url) {
    var params = qs.parse(qs.extract(url));
    return pick(params);
  }
...
var makeListDataReducer = function makeListDataReducer(paginationAdapter, customListReducer, customPaginationReducer) {
  var defaultListReducer = function defaultListReducer(prevState, _ref) {
    var data = _ref.payload.data,
        meta = _ref.meta;
    var newList = getOrSelect(data, paginationAdapter.list);
...
export { limitOffsetPaginationAdapter, nextPreviousPaginationAdapter, pickParamsFromUrl };
