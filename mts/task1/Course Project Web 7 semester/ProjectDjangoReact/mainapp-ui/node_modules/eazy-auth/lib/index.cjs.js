...
function makeAuthMiddleware(_ref) {
  ...
  var logout$ = action$.pipe(operators.filter(function (action) {
    return action.type === LOGOUT;
  })); // Subject for emit refresh tasks

  var refreshEmitter$ = new rxjs.Subject();
  var refresh$ = refreshEmitter$.asObservable().pipe(operators.exhaustMap(function (refreshToken) {
    return rxjs.concat(rxjs.of(tokenRefreshing()), rxjs.from(refreshTokenCall(refreshToken)).pipe(operators.map(function (refreshResponse) {
      ...
      return rxjs.of(logout());
    }), operators.takeUntil(logout$)));
  }), operators.publish()); // Make an Observable that complete with access token
  ...
  function waitForStoreRefreshObservable() {
    return action$.pipe(operators.filter(function (action) {
      return action.type === TOKEN_REFRESHED || action.type === LOGOUT;
    }), operators.take(1), operators.mergeMap(function (action) {
      if (action.type === LOGOUT) {
        return rxjs.throwError(UNAUTHORIZED_ERROR_SHAPE);
      }

      return rxjs.of(action.payload.accessToken);
    }));
  ...
  function getAccessToken() {
    ...
    if (!authBooted) {
      waitBoot$ = action$.pipe(operators.filter(function (action) {
        return action.type === BOOTSTRAP_AUTH_END;
      }), operators.take(1), operators.mergeMap(function () {
        return rxjs.empty();
      }));
    } else {
      waitBoot$ = rxjs.empty();
    ...
    return rxjs.concat(waitBoot$, rxjs.defer(function () {
  ...
  function onObsevableError(error, apiFn, firstAccessToken, args) {
    if (firstAccessToken !== null) {
      ...
      if (error.status === 401) {
        // Try refresh
        return refreshOnUnauth(firstAccessToken).pipe(operators.mergeMap(function (accessToken) {
          return rxjs.from(apiFn(accessToken).apply(void 0, args)).pipe(operators.catchError(function (error) {
  ...
  function callAuthApiObservable(apiFn) {
    ...
    return getAccessToken().pipe(operators.mergeMap(function (firstAccessToken) {
      return rxjs.from(apiFn(firstAccessToken).apply(void 0, args)).pipe(operators.catchError(function (error) {
  ...
  function run() {
    ...
    actionSubject$.pipe(operators.filter(function (action) {
      return action.type === BOOTSTRAP_AUTH_END;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return effects.call.apply(void 0, [[choosedStoageBackend, method]].concat(args));
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            _context15.prev = 1;
            _context15.next = 4;
            return effects.call.apply(void 0, [apiFn(accessToken)].concat(args));
          ...
          case 12:
            ...
            _context15.next = 15;
            return effects.put(tokenRefreshing());

          case 15:
            _context15.prev = 15;
            _context15.next = 18;
            return effects.call(refreshTokenCall, refreshToken);
          ...
          case 24:
            _context15.next = 26;
            return effects.call.apply(void 0, [apiFn(refresh.access_token)].concat(args));
    ...
    return regeneratorRuntime.wrap(function authApiCall$(_context16) {
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 21:
            _context16.next = 23;
            return effects.put(tokenRefreshed(_refresh));
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          ...
          case 7:
            _context18.prev = 7;
            _context18.next = 10;
            return effects.call(loginCall, credentials);
          ...
          case 10:
            ...
            _context18.next = 14;
            return effects.call(meCall, access_token, loginResponse);
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          ...
          case 3:
            ...
            _context20.next = 6;
            return effects.delay(1000 * _expires2);
          ...
          case 21:
            _context20.next = 23;
            return effects.put(tokenRefreshed({
      ...
      while (1) {
        switch (_context21.prev = _context21.next) {
          ...
          case 7:
            ...
            _context21.next = 10;
            return effects.fork(refreshOnExpirationLoop);
          ...
          case 13:
            ...
            _context21.next = 16;
            return effects.cancel(refreshTokenTask);
          ...
          case 31:
            ...
            _context21.next = 34;
            return effects.cancel(_refreshTokenTask);
...
function withAuthLogin(c) {
  ...
  return function wrapWithLogin(WrappedComponent) {
    ...
    var Login = reactRedux.connect(mapStateToProps, {
  ...
  return React__default.createElement(reactRouterDom.Route, _extends({}, rest, {
    render: function render(props) {
      if (auth.authenticatingWithToken || auth.loginLoading) {
        ...
        return spinner ? React__default.createElement(spinner) : null;
      } // User authenticated
...
var AuthRoute$1 = reactRedux.connect(function (_ref2) {
  var auth = _ref2.auth;
  return {
    auth: auth
  };
...
var MaybeAuthRoute$1 = reactRedux.connect(function (_ref2) {
  var auth = _ref2.auth;
  return {
    auth: auth
  };
...
var GuestRoute$1 = reactRedux.connect(function (_ref2) {
  var auth = _ref2.auth;
  return {
    auth: auth
  };
...
var reset = redux.combineReducers({
  check: checkToken,
  sent: sentReset
});
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 3;
                    return effects.take(mergePatterns(pattern, cancelPattern));
                  ...
                  case 3:
                    ...
                    _context3.next = 7;
                    return effects.cancel(lastTask);
                  ...
                  case 7:
                    ...
                    _context3.next = 10;
                    return effects.fork.apply(void 0, [saga].concat(args.concat(action)));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.prev = 3;
            _context.next = 6;
            return effects.call.apply(void 0, [recoverPasswordCall].concat(params));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.prev = 3;
            _context2.next = 6;
            return effects.call.apply(void 0, [checkResetPasswordTokenCall, token].concat(params));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            _context3.prev = 3;
            _context3.next = 6;
            return effects.call.apply(void 0, [resetPasswordCall, token, password].concat(params));
    ...
    return regeneratorRuntime.wrap(function passwordFlow$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return effects.fork(takeLatestAndCancel, RECOVER_PASSWORD, RECOVER_PASSWORD_UNLOAD, handleRecover);

          case 2:
            _context4.next = 4;
            return effects.fork(takeLatestAndCancel, RESET_PASSWORD_CHECK_TOKEN, RESET_PASSWORD_UNLOAD, handleCheckResetPasswordToken);

          case 4:
            _context4.next = 6;
            return effects.fork(takeLatestAndCancel, RESET_PASSWORD_SENT, RESET_PASSWORD_UNLOAD, handleResetPassword);
...
var isEmailValidMem = reselect.defaultMemoize(isEmailValid);
function withPasswordRecover() {
  return function wrapWithRecover(WrappedComponent) {
    ...
    var Recover = reactRedux.connect(mapStateToProps, {
...
function withPasswordReset(c) {
  ...
  var isPasswordValid = reselect.defaultMemoize(config.passwordValidator);
  return function wrapWithReset(WrappedComponent) {
    ...
    var Reset = reactRedux.connect(mapStateToProps, {
...
exports.AUTH_WITH_TOKEN_FAILURE = AUTH_WITH_TOKEN_FAILURE;
exports.AUTH_WITH_TOKEN_LOADING = AUTH_WITH_TOKEN_LOADING;
exports.AUTH_WITH_TOKEN_SUCCESS = AUTH_WITH_TOKEN_SUCCESS;
exports.AuthRoute = AuthRoute$1;
exports.BOOTSTRAP_AUTH_END = BOOTSTRAP_AUTH_END;
exports.BOOTSTRAP_AUTH_START = BOOTSTRAP_AUTH_START;
exports.CLEAR_LOGIN_ERROR = CLEAR_LOGIN_ERROR;
exports.GuestRoute = GuestRoute$1;
exports.LOGIN = LOGIN;
exports.LOGIN_FAILURE = LOGIN_FAILURE;
exports.LOGIN_LOADING = LOGIN_LOADING;
exports.LOGIN_SUCCESS = LOGIN_SUCCESS;
exports.LOGOUT = LOGOUT;
exports.MaybeAuthRoute = MaybeAuthRoute$1;
exports.PATCH_USER = PATCH_USER;
exports.RECOVER_PASSWORD = RECOVER_PASSWORD;
exports.RECOVER_PASSWORD_FAILURE = RECOVER_PASSWORD_FAILURE;
exports.RECOVER_PASSWORD_LOADING = RECOVER_PASSWORD_LOADING;
exports.RECOVER_PASSWORD_SUCCESS = RECOVER_PASSWORD_SUCCESS;
exports.RECOVER_PASSWORD_UNLOAD = RECOVER_PASSWORD_UNLOAD;
exports.RESET_PASSWORD_CHECK_TOKEN = RESET_PASSWORD_CHECK_TOKEN;
exports.RESET_PASSWORD_CHECK_TOKEN_FAILURE = RESET_PASSWORD_CHECK_TOKEN_FAILURE;
exports.RESET_PASSWORD_CHECK_TOKEN_LOADING = RESET_PASSWORD_CHECK_TOKEN_LOADING;
exports.RESET_PASSWORD_CHECK_TOKEN_SUCCESS = RESET_PASSWORD_CHECK_TOKEN_SUCCESS;
exports.RESET_PASSWORD_SENT = RESET_PASSWORD_SENT;
exports.RESET_PASSWORD_SENT_FAILURE = RESET_PASSWORD_SENT_FAILURE;
exports.RESET_PASSWORD_SENT_LOADING = RESET_PASSWORD_SENT_LOADING;
exports.RESET_PASSWORD_SENT_SUCCESS = RESET_PASSWORD_SENT_SUCCESS;
exports.RESET_PASSWORD_UNLOAD = RESET_PASSWORD_UNLOAD;
exports.TOKEN_REFRESHED = TOKEN_REFRESHED;
exports.TOKEN_REFRESHING = TOKEN_REFRESHING;
...
exports.getAuthTokenExpires = getAuthTokenExpires;
exports.getAuthUser = getAuthUser;
exports.getCheckResetPasswordTokenError = getCheckResetPasswordTokenError;
exports.getLoginError = getLoginError;
exports.getPasswordRecoverEmail = getPasswordRecoverEmail;
exports.getPasswordRecoverError = getPasswordRecoverError;
exports.getResetPasswordError = getResetPasswordError;
exports.getResetPasswordToken = getResetPasswordToken;
exports.isCheckingResetPasswordToken = isCheckingResetPasswordToken;
exports.isLoginLoading = isLoginLoading;
exports.isPasswordRecoverLoading = isPasswordRecoverLoading;
exports.isPasswordRecovered = isPasswordRecovered;
exports.isPasswordResetted = isPasswordResetted;
exports.isResettingPassword = isResettingPassword;
exports.login = login;
exports.logout = logout;
exports.makeAuthFlow = makeAuth;
exports.makeAuthReducer = makeAuthReducer;
exports.makePasswordFlow = makePassword;
exports.makePasswordReducer = makePasswordReducer;
exports.patchUser = patchUser;
exports.recoverPassword = recoverPassword;
exports.resetPassword = resetPassword;
exports.tokenRefreshed = tokenRefreshed;
exports.tokenRefreshing = tokenRefreshing;
exports.unloadPasswordRecover = unloadPasswordRecover;
exports.unloadPasswordReset = unloadPasswordReset;
exports.updateUser = updateUser;
exports.withAuthLogin = withAuthLogin;
exports.withPasswordRecover = withPasswordRecover;
exports.withPasswordReset = withPasswordReset;
