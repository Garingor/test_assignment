...
var DeBp = /*#__PURE__*/function () {
  function DeBp(value, c) {
    ...
    var config = _extends__default['default']({}, DefaultConfig, c);
  ...
  _proto.withMeta = function withMeta(newMeta) {
    this._meta = _extends__default['default']({}, this._meta, newMeta);
    return this;
  };
...
var WithMetaDeBp = function WithMetaDeBp(a, meta) {
  return ifDep(a, function () {
    return new DeBp(a.getValue(), {
      ...
      meta: _extends__default['default']({}, a.getMeta(), meta)
    });
  }, function () {
    return new DeBp(a, {
      shouldRun: true,
...
var maybeGet = function maybeGet(a, path) {
  ...
  if (obj) {
    return RunDeBp(utils.get(obj, path));
  }
...
function getMetaFromDeps(argsWithDeps, oldValues, onMount) {
  ...
  if (oldValues === null) {
    ...
    return argsWithDeps.reduce(function (meta, arg, i) {
      return _extends__default['default']({}, meta, getDepMeta(argsWithDeps[i], _useOnMount));
    }, {});
  }
  ...
  return argsWithDeps.reduce(function (meta, arg, index) {
    if (index >= oldValuesLen || getDepValue(arg) !== oldValues[index]) {
      ...
      if (depMeta) {
        return _extends__default['default']({}, meta, depMeta);
      }
...
function forgeRocketJump(rjImpl) {
  ...
  function rj() {
    ...
    if (typeof rjImpl.makePartialConfig === 'function') {
      ...
      partialConfig = utils.mergeConfigs(partialRjsOrConfigs);
    } // Make the partial rj
    ...
    function PartialRj(extraConfig, extendExportArg, runRjImpl) {
      ...
      var finalConfig = utils.mergeConfigs([partialConfig, extraConfig]);
...
function withMeta$1(meta) {
  var out = makeEffectAction(_extends__default['default']({}, this, {
    meta: typeof meta === 'function' ? meta(this.meta) : _extends__default['default']({}, this.meta, meta)
  }));
...
function extend(extensions) {
  var out = makeEffectAction(_extends__default['default']({}, this, {
    meta: _extends__default['default']({}, this.meta, extensions.meta),
    callbacks: {
...
var Builder = /*#__PURE__*/function () {
  ...
  _proto.withMeta = function withMeta(meta) {
    if (typeof meta === 'function') {
      ...
      this.metaTransforms.push(function (oldMeta) {
        return _extends__default['default']({}, oldMeta, meta);
      });
    }
  ...
  _proto.curry = function curry() {
    ...
    var callbacks = _extends__default['default']({}, this.callbacks);

    var curriedCallbacks = _extends__default['default']({}, this.curriedCallbacks);
    ...
    var makeBuilder = function makeBuilder() {
      ...
      var builder = _construct__default['default'](Builder, args);
...
function attachBuilder(boundActionCreator, actionCreator, dispatch, makeBuilder) {
  if (makeBuilder === void 0) {
    makeBuilder = function makeBuilder() {
      ...
      return _construct__default['default'](Builder, args);
    };
  }
...
function createUseRunRj(useRj) {
  return function useRunRj(rjObject, runArgs, shouldCleanOnNewEffect) {
    ...
    var prevWithMeta = react.useRef(null);
    var runValues = getRunValuesFromDeps(runArgs);
    var prevRunValues = react.useRef(null);
    react.useEffect(function () {
      ...
      if (shouldRun) {
        ...
        (_run$withMeta = run.withMeta(_extends__default['default']({}, meta, hackRunWithMeta))).run.apply(_run$withMeta, runValues);
      }
    ...
    var actions = react.useMemo(function () {
      return _extends__default['default']({}, originalActions, {
  ...
  */
  ...
  return function computeState(state, selectors) {
    return computedKeys.reduce(function (computedState, selectorName) {
      ...
      return _extends__default['default']({}, computedState, (_extends2 = {}, _extends2[keyName] = selector(state), _extends2));
    }, {});
  };
}
...
var deps = _extends__default['default']({}, allDeps); // Remove es6 module shit

exports.bindActionCreators = bindActionCreators;
exports.createComputeState = createComputeState;
exports.createUseRunRj = createUseRunRj;
exports.deps = deps;
exports.forgeRocketJump = forgeRocketJump;
exports.getMetaFromDeps = getMetaFromDeps;
exports.getRunValuesFromDeps = getRunValuesFromDeps;
exports.isEffectAction = isEffectAction;
exports.isObjectRj = isObjectRj;
exports.isPartialRj = isPartialRj;
exports.makeExportValue = makeExportValue;
exports.makeLibraryAction = makeLibraryAction;
exports.shouldRunDeps = shouldRunDeps;
exports.squashExportValue = squashExportValue;
