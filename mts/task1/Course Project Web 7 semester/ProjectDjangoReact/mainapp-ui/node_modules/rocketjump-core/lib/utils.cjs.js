...
function invertKeys(object) {
  return Object.keys(object).reduce(function (inverted, key) {
    ...
    return _extends__default['default']({}, inverted, (_extends2 = {}, _extends2[object[key]] = key, _extends2));
  }, {});
...
function mergeConfigs(rjsOrConfigs) {
  return rjsOrConfigs.reduce(function (finalConfig, config) {
    ...
    return _extends__default['default']({}, finalConfig, config);
  }, {});
} // Thanks lodash
...
var proxyObject = function proxyObject(obj, proxy) {
  if (typeof proxy === 'function') {
    return _extends__default['default']({}, obj, proxy(obj));
  }

  if (typeof proxy === 'object' && proxy !== null) {
    return _extends__default['default']({}, obj, mapValues(proxy, function (proxyFn) {
      return proxyFn(obj);
    }));
  }
  ...
  return function (prevState, action) {
    return reducers.reduce(function (nextState, reducer) {
      if (typeof prevState === 'undefined') {
        ...
        return _extends__default['default']({}, nextState, reducer(undefined, action));
      } else {
...
exports.arrayze = arrayze;
exports.composeReducers = composeReducers;
exports.get = get;
exports.invertKeys = invertKeys;
exports.kompose = kompose;
exports.mapValues = mapValues;
exports.matchActionPattern = matchActionPattern;
exports.mergeActionPatterns = mergeActionPatterns;
